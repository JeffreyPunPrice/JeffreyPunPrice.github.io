...
```
LangCodes(2) × ShopTypes(2) × users (1) × routes(2)
 × deliveryOption(1) × areaOption(1) × receiverList(1)
 × codeListToFuncs(87) (13 + 61 + 13)
= 696

productOnlyCodes(Only EC) = LangCodes(2) × ShopTypes = PS(1)
 × users (1) × routes(2) × deliveryOption(1)
  × areaOption(1) × receiverList(1) × codeListToFuncs(24) = 96
...
productOnlyCodes(Only EC) = LangCodes(2) × ShopTypes = PS(1)
 × users (1) × routes(2) × deliveryOption(1)
  × areaOption(1) × receiverList(1) × codeListToFuncs(20) = 80
